...
export function activationDay30Email(companyName: string): { subject: string; html: string } {
  ...
  const html = emailLayout(subject, `
    <p style="margin:0 0 4px;font-size:13px;color:#94a3b8;">A quick question from the Thrive founder.</p>
    <h1 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#1e293b;">One month in, ${companyName}</h1>
    <p style="margin:0 0 16px;font-size:15px;color:#475569;line-height:1.6;">
      Hey — it's Paul from Thrive.
    </p>
    <p style="margin:0 0 16px;font-size:15px;color:#475569;line-height:1.6;">
      It's been a month since you joined. I'd genuinely love to know: <strong>have you hired anyone through Thrive yet?</strong>
    </p>
    <p style="margin:0 0 16px;font-size:15px;color:#475569;line-height:1.6;">
    ...
    <p style="margin:0 0 16px;font-size:15px;color:#475569;line-height:1.6;">
      If things haven't worked out yet, I want to understand why. What's missing? What would make Thrive more useful for you? Hit reply and let me know — I read every response.
    </p>
    ${ctaButton('Share your feedback', `${BASE_URL}/employer/dashboard`)}
    <p style="margin:0;font-size:14px;color:#94a3b8;">
      Paul Davies, Founder — Thrive
    </p>
  `)
